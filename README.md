# workshop-template-rmd-ga [![gh-actions-build-status](https://github.com/zifornd/workshop-template-rmd-ga/workflows/build/badge.svg)](https://github.com/zifornd/workshop-template-rmd-ga/actions?workflow=build)
