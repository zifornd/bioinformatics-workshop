...
This workshop is aimed towards biologists, researchers, computer scientists or data analysts planning to run, analyse and interpret bioinformatics data. Basic knowledge of working on the Unix/Linux command line is expected.
