...
knitr::include_graphics("assets/bulk_vs_single.jpg")
```
...
knitr::include_graphics("assets/Heterogeneous_Cells.jpg")
```
...
```{r, fig.cap="Single-cell RNA sequencing workflow", out.width="70%"}
knitr::include_graphics("assets/Single_Cell_Genome_Sequencing_Workflow.jpg")
```
...
knitr::include_graphics("assets/RNA-Seq_workflow-5.jpg")
```
...
knitr::include_graphics("assets/SEURAT_scRNASeq_workflow.jpg")
```
...
.pull-right-50[
```{r, out.width="60%"}
knitr::include_graphics("assets/KMeans-Gaussian-data.png")
```

```{r, out.width="100%"}
knitr::include_graphics("assets/scrna_PCA.png")
```
]
---
# Clustering Concepts
...
.pull-right-50[
```{r, out.width="65%"}
knitr::include_graphics("assets/scrna_TSNE.png")
```
]
<br style="clear: both">
...
```{r, out.width="80%"}
knitr::include_graphics("assets/cell-markers.jpg")
```
...
```{r, out.width="85%"}
knitr::include_graphics("assets/scrna_seq_trajectory_analysis.png")
```
---
...
```{r, out.width="85%"}
knitr::include_graphics("assets/scrna_applications.png")
```
---
name: end_slide
